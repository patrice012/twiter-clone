  ...
  return (function () {
    ...
    function re(e) {
      if (e.getRootNode && e.getRootNode() instanceof ShadowRoot) {
        return $().body.contains(e.getRootNode().host);
      } else {
    ...
    function N(e, t) {
      if (t.indexOf("closest ") === 0) {
        return [A(e, t.substr(8))];
      } else if (t.indexOf("find ") === 0) {
        return [C(e, t.substr(5))];
      } else if (t.indexOf("next ") === 0) {
        return [I(e, t.substr(5))];
      } else if (t.indexOf("previous ") === 0) {
        return [k(e, t.substr(9))];
      } else if (t === "document") {
        return [document];
      } else if (t === "window") {
        return [window];
    ...
    function P(e, t, r) {
      if (p(t)) {
        return { target: $().body, event: e, listener: t };
      } else {
        return { target: M(e), event: t, listener: r };
      }
    }
    function D(t, r, n) {
      pr(function () {
    ...
    function V(e, i, a) {
      ...
      if (r) {
        ...
        i.parentNode.removeChild(i);
        Q($().body, "htmx:oobErrorNoTarget", { content: i });
      }
      return e;
    }
    function _(e, t, r) {
    ...
    function le(i, e, a) {
      Y(e.querySelectorAll("[id]"), function (e) {
        if (e.id && e.id.length > 0) {
          var t = e.id.replace("'", "\\'");
          var r = i.querySelector(e.tagName + "[id='" + t + "']");
          if (r && r !== i) {
            var n = e.cloneNode();
            j(e, r);
            a.tasks.push(function () {
              j(e, n);
            });
          }
        }
      ...
      switch (e) {
        ...
        default:
          ...
          if (e === "innerHTML") {
            ...
            Ce(z.config.defaultSwapStyle, t, r, n, i);
          }
      }
    }
    function Re(e) {
          ...
          if (o === "]") {
            ...
            if (n === 0) {
              ...
              try {
                ...
                Q($().body, "htmx:syntax:error", { error: e, source: i });
                return null;
              }
            }
          } else if (o === "[") {
    ...
    function Be(e, t, r) {
      ...
      n.timeout = setTimeout(function () {
        if (re(e) && n.cancelled !== true) {
          if (!We(r, yt("hx:poll:trigger", { triggerSpec: r, target: e }))) {
            t(e);
          }
          Be(e, t, r);
        }
    ...
    function Ve(e, t) {
      if (e.type === "submit" || e.type === "click") {
        ...
        if (d(t, 'input[type="submit"], button') && A(t, "form") !== null) {
          return true;
        }
        if (
          t.tagName === "A" &&
    ...
    function We(e, t) {
      ...
      if (r) {
        try {
          ...
          Q($().body, "htmx:eventFilter:error", { error: e, source: r.source });
          return true;
        }
      }
      return false;
    }
    function ze(i, a, e, o, s) {
      var l = K(i);
      var t;
      if (o.from) {
        t = N(i, o.from);
      ...
      Y(t, function (r) {
        ...
        e.listenerInfos.push({ trigger: o.trigger, listener: n, on: r });
    ...
    function Ye(s, r, n) {
      ...
      t.onerror = function (e) {
        Q(s, "htmx:wsError", { error: e, socket: t });
        Qe(s);
      };
    ...
    function et(u) {
      ...
      if (f) {
        ...
        Q(u, "htmx:noWebSocketSourceError");
      }
    }
    function tt(e) {
    ...
    function nt(t, e) {
      ...
      r.onerror = function (e) {
        Q(t, "htmx:sseError", { error: e, source: r });
        ot(t);
      };
    ...
    function Rt(e, t, r, n) {
      ...
      while (i.length > 0) {
        try {
          ...
          Q($().body, "htmx:historyCacheError", { cause: e, cache: i });
          i.shift();
        }
      }
    }
    ...
    function Tt() {
      ...
      if (!r) {
        ee($().body, "htmx:beforeHistorySave", { path: t, historyElt: e });
        Rt(t, qt(e), $().title, window.scrollY);
      }
      if (z.config.historyEnabled)
        history.replaceState({ htmx: true }, $().title, window.location.href);
    }
    function Lt(e) {
    ...
    function Ht(e) {
      if (z.config.historyEnabled) history.replaceState({ htmx: true }, "", e);
      Et = e;
    }
    function At(e) {
      Y(e, function (e) {
    ...
    function Nt(a) {
      ...
      e.onload = function () {
        if (this.status >= 200 && this.status < 400) {
          ...
          Q($().body, "htmx:historyCacheMissLoadError", o);
        }
      };
      e.send();
    }
    ...
    function Xt(t, r, n, e, i) {
      ...
      if (Dt(e)) {
        ...
        var o = e.value;
        if (e.multiple) {
          o = x(e.querySelectorAll("option:checked")).map(function (e) {
            return e.value;
          });
        }
        if (e.files) {
    ...
    function Jt(e) {
      return (
        ...
        (d(e, "form") && G(e, "enctype") === "multipart/form-data")
      );
    }
    function $t(t, r, n) {
      var i = null;
    ...
    function ir(t) {
      if (t.responseURL && typeof URL !== "undefined") {
        try {
          ...
          Q($().body, "htmx:badResponseUrl", { url: t.responseURL });
        }
      }
    }
    function ar(e, t) {
    ...
    function or(e, t, r) {
      e = e.toLowerCase();
      if (r) {
        if (r instanceof Element || g(r, "String")) {
          return lr(e, t, null, null, {
            targetOverride: M(r),
            returnPromise: true,
          });
        } else {
          return lr(e, t, M(r.source), r.event, {
            handler: r.handler,
            headers: r.headers,
            values: r.values,
    ...
    function lr(e, t, n, r, i, f) {
      ...
      if (g == null || g == ae) {
        Q(n, "htmx:targetError", { target: J(n, "hx-target") });
        return;
      }
      if (!f) {
        var p = function () {
      ...
      if (O) {
        var q = prompt(O);
        if (q === null || !ee(n, "htmx:prompt", { prompt: q, target: g })) {
          te(c);
          s();
          return d;
        }
      ...
      if (z.config.getCacheBusterParam && e === "get") {
        M["org.htmx.cache-buster"] = G(g, "id") || "true";
      }
      if (t == null || t === "") {
        t = $().location.href;
      }
      ...
      var l = {
        ...
        errors: A,
        withCredentials:
          i.credentials || P.credentials || z.config.withCredentials,
      ...
      var u = {
        ...
        etc: i,
        boosted: D,
        pathInfo: { requestPath: t, finalRequestPath: j || t, anchor: B },
      };
      o.onload = function () {
        try {
          var e = sr(n);
          ...
          Q(n, "htmx:onLoadError", ne({ error: e }, u));
          throw e;
        }
      };
      o.onerror = function () {
      ...
      var W = kt(n);
      Y(["loadstart", "loadend", "progress", "abort"], function (t) {
        Y([o, o.upload], function (e) {
    ...
    function fr(s, l) {
      ...
      if (ar(u, /HX-Retarget:/i)) {
        l.target = $().querySelector(u.getResponseHeader("HX-Retarget"));
      }
      var h = ur(s, l);
      var i = u.status >= 200 && u.status < 400 && u.status !== 204;
      var d = u.response;
      var t = u.status >= 400;
      var r = ne({ shouldSwap: i, serverResponse: d, isError: t }, l);
          ...
          try {
            ...
            var o = function () {
              ...
              if (h.type) {
                if (h.type === "push") {
                  Lt(h.path);
                  ee($().body, "htmx:pushedIntoHistory", { path: h.path });
                } else {
                  Ht(h.path);
                  ee($().body, "htmx:replacedInHistory", { path: h.path });
                }
              }
    ...
    pr(function () {
      ...
      window.onpopstate = function (e) {
        if (e.state && e.state.htmx) {
          It();
          Y(t, function (e) {
            ee(e, "htmx:restored", { document: $(), triggerEvent: ee });
          });
        }
      };
      setTimeout(function () {
